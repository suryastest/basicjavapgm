...
public class Relationaloperator {
	...
	public static void main(String[] args) {
		// Relational Operators are used to determine the comparison between two or more objects.
		//These operators always return the boolean value either true or false when used in an expression.
